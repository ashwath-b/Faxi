...
• The customer ends the ride at some location. The cab waits around outside the customer’s house, and is available to be
  assigned to another customer.

Notes:
• You can build this in any programming language of your choice
• We expect good unit tests
• Unfortunately, you skipped Geography, and believe the earth is flat. The distance between two points can be calculated
...
references:
https://gist.github.com/sowenjub/1663423
